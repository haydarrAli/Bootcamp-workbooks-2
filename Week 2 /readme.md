...
Additionally, I completed Power BI Desktop labs covering data retrieval, loading converted data, report design, and dashboard creation. My abilities to create dashboards, analyze trends, visualize data, and use data to inform decisions have all improved as a result of my work.
...
![description of the image](image7.png)
